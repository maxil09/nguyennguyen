...
$(document).ready(function () {
  ...
  let text =
   "Chúc Gnhi Giáng Sinh an lành.Chúc tất cả ước mơ của bạn sẽ trở thành hiện thực trong năm mới!!!.Chúc bạn sẽ đạt thật nhiều thành tích cao trong những kì thi trong năm mới!!!!! ";
